...
def run_graph(image_data, labels, input_layer_name, output_layer_name,
  ...
  with tf.Session() as sess:
    ...
    if(predictions[top_k[0]]>=0.6):
        if(labels[top_k[0]]=="potato"):
            print("%.2f%% Potato" % (predictions[top_k[0]]*100))
        else: print("%.2f%% Not Potato" % (predictions[top_k[0]]*100))
    else: print("%.2f%% Not Potato" % (predictions[top_k[1]]*100))
    return 0
'''
